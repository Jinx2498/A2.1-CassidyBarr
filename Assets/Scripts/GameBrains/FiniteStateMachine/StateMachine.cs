...
namespace GameBrains.FiniteStateMachine
{
    ...
    public sealed class StateMachine : ExtendedMonoBehaviour
    {
        ...
        [SerializeField] RegulatorMode mode;
        [SerializeField] DelayDistribution regulatorDistribution;
        ...
        {
            get => regulatorDistribution;
            set => regulatorDistribution = value;
        }
