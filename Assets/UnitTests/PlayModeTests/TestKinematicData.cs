...
namespace UnitTests.PlayModeTests
{
    public sealed class TestKinematicData
    {
        ...
        public void TestKinematicDataConstructor()
        {
            ...
            KinematicData kinematicData = new KinematicData(tempTransform);
            ...
            kinematicData = new KinematicData(tempTransform)
            {
                MaximumSpeed = 6,
                MaximumAngularSpeed = 360,
                MaximumAcceleration = 1,
                MaximumAngularAcceleration = 180,
                Location = new VectorXZ(1, 1),
                Orientation = 181,
                Velocity = new VectorXZ(3, 6),
                AngularVelocity = 361,
                Acceleration = new VectorXZ(1, 1),
                AngularAcceleration = 181
            };
        ...
        {
            Transform tempTransform = new GameObject().transform;
            KinematicData kinematicDataSource = new KinematicData(tempTransform)
            {
                MaximumSpeed = 1,
                MaximumAngularSpeed = 1,
                MaximumAcceleration = 1,
                MaximumAngularAcceleration = 1,
                Location = new VectorXZ(1, 1),
                Orientation = 1,
                Velocity = new VectorXZ(1, 1),
                AngularVelocity = 1,
                Acceleration = new VectorXZ(1, 1),
                AngularAcceleration = 1
            };

            KinematicData kinematicDataCopy = new KinematicData(kinematicDataSource);
        ...
        {
            Transform tempTransform = new GameObject().transform;
            var kinematicData = new KinematicData(tempTransform);
        ...
        public void TestKinematicDataCalculatePosition()
        {
            ...
            Assert.AreEqual(new VectorXZ(0, 16), kinematicData.Location);
        ...
        public void TestKinematicDataCalculateOrientation()
        {
            ...
            KinematicData kinematicData
                = new KinematicData(tempTransform)
                {
                    Orientation = 360 // wrap angle to 0
                };
        ...
        public void TestKinematicDataUpdate()
        {
            ...
            kinematicData.Update(deltaTime);
